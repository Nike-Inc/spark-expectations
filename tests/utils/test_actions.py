            ...
            spark.createDataFrame(
                [  # drop & log into error
                    ...
                    # drop & log into error
                    {
                        "col1": 2,
                        "col2": "b",
                        "meta_row_dq_results": [{"action_if_failed": "drop"}],
                    },
                    # log into final
            ...
            spark.createDataFrame(
                [
                    ...
                    # log into final
                    {
                        "col1": 2,
                        "col2": "b",
                        "meta_row_dq_results": [{"action_if_failed": "test"}],
                    },
                    # log into final
                    {"col1": 3, "col2": "c", "meta_row_dq_results": []},
                ]
...
@patch(
    "spark_expectations.utils.actions.SparkExpectationsContext.set_final_agg_dq_status",
    autospec=True,
    spec_set=True,
)
@patch(
    "spark_expectations.utils.actions.SparkExpectationsContext.set_source_agg_dq_status",
    autospec=True,
    spec_set=True,
)
@patch(
    "spark_expectations.utils.actions.SparkExpectationsContext.set_row_dq_status",
    autospec=True,
    spec_set=True,
)
            ...
            spark.createDataFrame(
                [
                    ...
                    },
                    {
                        "col1": 2,
                        "col2": "b",
                        "row_dq_results": [{"action_if_failed": "test"}],
                    },
