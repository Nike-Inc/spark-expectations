...
def test_with_expectations_patch(_write_error_stats,
    ...
    decorated_func = _fixture_spark_expectations.with_expectations(
        "dq_spark.test_final_table",
        user_conf={user_config.se_notifications_on_fail: False,user_config.se_enable_query_dq_detailed_result: True, user_config.se_enable_agg_dq_detailed_result: True},
