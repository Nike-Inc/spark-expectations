...
class SparkExpectationsContext:
    ...
    def __post_init__(self) -> None:
        ...
        self._se_streaming_stats_topic_name: str = None
        self._se_streaming_stats_kafka_bootstrap_server: str = None
    ...
    def get_topic_name(self) -> Optional[str]:
        ...
        if self.get_se_streaming_stats_kafka_custom_config_enable:
            _topic_name = self._se_streaming_stats_dict.get(user_config.se_streaming_stats_topic_name)
        else:
