...
class SparkExpectations:
    ...
    def __post_init__(self) -> None:
        ...
        #self.rules_df = self.rules_df.persist(StorageLevel.MEMORY_AND_DISK) # commented for Serverless
    ...
    def with_expectations(
        ...
        def _except(func: Any) -> Any:
            ...
            # _default_notification_dict, _default_stats_streaming_dict = get_config_dict(self.spark, user_conf) # commented for Serverless
            _default_notification_dict, _default_stats_streaming_dict = {}, {}  # for Serverless
