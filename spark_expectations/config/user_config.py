...
# spark.expectations.notifications.slack
# .webhook_url https://hooks.slack.com/services/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
# spark.expectations.notifications.slack.subject.default "Message from your Friendly Workflow"
# spark.expectations.notifications.slack.body.default "Just Testing things out\nvia Workflow"
# spark.expectations.notifications.slack.template "#{subject}\n#{body}"
# "spark.expectations.notifications.slack.subject":""
