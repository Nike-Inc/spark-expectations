...
def set_up_bigquery(materialization_dataset: str) -> SparkSession:
    ...
    # Add dependencies like gcs-connector-hadoop3-2.2.6-SNAPSHOT-shaded.jar, spark-avro_2.12-3.4.1.jar
    # if you wanted to use indirect method for reading/writing
    return spark
